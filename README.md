Алгоритмы в [Яндекс.Практикуме](https://practicum.yandex.ru/ "Яндекс.Практикуме"). Решались еще в те времена, когда ChatGPT не существовал =)
Далее идут шесть решенных мной задач, с описанием задания, его решением и ссылкой на файл .py
